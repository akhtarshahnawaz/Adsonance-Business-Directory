    ...
    <div class="span12">
        ...
        <div class="container-fluid">
            <div class="span8 offset1 well">
                ...
                <?php endif; ?>
                <p class="lead" align="center">Select a website to get Email</p>
                ...
                <table class="table table-bordered table-condensed table-striped">
                    ...
                    <tbody>
                        ...
                        <?php if(isset($data['webKey']) && $data['webKey']!=null):?>
                            <?php $totalListingsWithWebsite+=1; ?>
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-vertical">
                                    <?php if(isset($data['maxEmails']) && $data['maxEmails']>0):?>
                                    <a class="btn btn-danger btn-mini" href="<?php echo site_url('panel/emails/manage').'/'.$data['webKey'];?>">Manage Emails</a>
                                    <a class="btn btn-success btn-mini" href="<?php echo site_url('panel/emails/order').'/'.$data['webKey'];?>">Get more emails</a>
                                    <?php else: ?>
                                    <a class="btn btn-success btn-mini" href="<?php echo site_url('panel/emails/order').'/'.$data['pkey'];?>">Get email for your website</a>
                        ...
                        <?php if($totalListingsWithWebsite==0):?>
                    <table  class="table table-bordered table-condensed table-striped">
                        <tr>
                            <td>
                                <p align="center" class="text-warning">You have not created any website yet. Click create website and get Custom Domain to get Emails now.</p>
                                <p align="center"> <a href="<?php echo site_url('panel/website/unassListings');?>" class="btn btn-success">Create a Website Now</a></p>
                    ...
                    <div class="alert alert-block">
                        ...
                        <p align="center">You need to create a Business Listing & Website before creating an Email. Click below to create a business listing.</p>
