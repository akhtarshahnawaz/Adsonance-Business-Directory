...
<p class="lead" align="center">Order Email</p>
        ...
        echo form_open('panel/emails/order', $attributes); ?>
        ...
        <div class="control-group">
            <label class="control-label" for="emails">No of Emails</label>
            <div class="controls">
                <input class="input-xxlarge"  type="text" value=""  name="noOfEmails" id="emails" placeholder="No of Emails Required">
            </div>
        </div>
