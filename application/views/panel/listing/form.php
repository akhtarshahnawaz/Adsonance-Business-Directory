...
<p class="lead" align="center">List your Business Now</p>
...
if(isset($update) && $update==true){
    $route='panel/index/edit';
}else{
    $route='panel/index/create';
}
echo form_open($route, $attributes); ?>
...
<div class="control-group">
    ...
    <div class="controls">
        ...
        <input type="file"  class="input-block-level" action="<?php echo site_url('panel/index/uploadImage');?>"  name="inputImage" id="inputImage"></br></br>
