            ...
            <div class="span8 offset1 well">
                ...
                <table class="table table-bordered table-condensed table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a class="btn btn-primary btn-mini" href="<?php echo site_url('panel/index/edit').'/'.$data['pkey'];?>">Edit</a>
                                <a class="btn btn-danger btn-mini" href="<?php echo site_url('panel/index/deleteListing').'/'.$data['pkey'];?>">Delete</a>
                            </div>
                        </td>
                    </tr>
                        <?php endforeach; ?>
                    ...
                    <div class="alert alert-block">
                        ...
                        <p align="center">You have not listed any of your business till now. List your Business by pressing create a Lisiting</p>
                        <p align="center"> <a href="<?php echo site_url('panel/index/create');?>" class="btn btn-success">List your Business Now</a></p>
                    </div>
                    <?php  endif; ?>
                </table>
