    ...
    <div class="span12">
        ...
        <div class="container-fluid">
            <div class="span8 offset1 well">
                ...
                <?php endif; ?>
                <p class="lead" align="center">Manage Websites</p>
                ...
                <table class="table table-bordered table-condensed table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-vertical">
                                    <?php if(isset($data['webKey']) && $data['webKey']!=null):?>
                                    <a class="btn btn-danger btn-mini" href="<?php echo site_url('panel/website/manage').'/'.$data['webKey'];?>">Manage Website</a>

                                    <?php if($data['url']==null):?>
                                        <a class="btn btn-success btn-mini" href="<?php echo site_url('panel/website/orderCustomDomain').'/'.$data['webKey'];?>">Get Custom Domain </a>
                                        <?php endif; ?>
                    ...
                    <table  class="table table-bordered table-condensed table-striped">
                        <tr>
                            <td>
                                <p align="center" class="text-warning">You have not created any website yet. Click create website to make a website now.</p>
