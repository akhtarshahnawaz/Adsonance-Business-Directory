    ...
    <div class="span12">
        ...
        <div class="container-fluid">
            <div class="span9 well">
                <p class="lead" align="center">Order More Pages</p>
                ...
                echo form_open('panel/website/getMorePages', $attributes); ?>
                ...
                <div class="control-group">
                    <label class="control-label" for="pages">No of Pages</label>
                    <div class="controls">
                        <input class="input-xxlarge"  type="text" value=""  name="noOfPages" id="pages" placeholder="Number of Pages to Order">
                    </div>
                </div>
