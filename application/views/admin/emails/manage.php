<div class="span9">
    ...
    <div class="btn-group pull-right">
        <a class="btn btn-success btn-small" href="<?php echo site_url('admin/emails/create').'/'.$webKey;?>">Add Email</a>
    </div>
        ...
        <div class="well">
            <table class="table table-bordered table-condensed table-striped">
                ...
                <tr class="<?php if($row['status']==0){ echo 'warning';}elseif($row['status']==1){ echo 'success';} ?>">
                    ...
                    <td><?php echo $row['prevEmail']; ?></td>
                    <td><?php echo $row['password']; ?></td>

                    <td><?php if($row['status']==0){ echo 'Pending '.$row['type'];}elseif($row['status']==1){ echo 'Running OK';} ?></td>
                    <td>
                        <div class="btn-group ">
                            <a class="btn btn-mini btn-primary" href="<?php echo site_url('admin/emails/update/').'/'.$row['pkey'];?>">Edit</a>
                            <a class="btn btn-mini btn-danger" href="<?php echo site_url('admin/emails/deleteEmail/').'/'.$row['pkey'].'/'.$webKey;?>">Delete</a>
                        </div>
                    </td>
                </tr>
                    <?php endforeach; ?>
