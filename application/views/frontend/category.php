...
<div class="container-fluid">
    <div class="span8 offset1">
        ...
        <div class="pagination">
            ...
            <ul>
                <?php if(($page-1)>=0):?>
                <li><a href="<?php echo site_url('home/category').'/'.$catKey.'/'.($page-1);?>">Prev</a></li>
                <?php endif; ?>
                <?php for($i=0;$i<$totalPages;$i++):?>
                <li <?php if($i==$page){ echo 'class="disabled"';}?> ><a href="<?php echo site_url('home/category').'/'.$catKey.'/'.$i;?>"><?php echo $i+1 ?></a></li>
                <?php endfor; ?>
                <?php if(($page+1)<$totalPages):?>

                <li><a href="<?php echo site_url('home/category').'/'.$catKey.'/'.($page+1);?>">Next</a></li>
                <?php endif; ?>
